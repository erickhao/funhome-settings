...
def show_log(old):
    ...
    #utils.ADDON_NAME
    if(not old):
        logviewer.window("FunHomeTV User License | FunHomeTV 用户协议", content, default=utils.is_default_window())
    else:
        logviewer.window("logviewer", content, default=utils.is_default_window())
